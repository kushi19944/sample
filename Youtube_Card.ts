...
async function Start(){
    ...
    // 設定するアカウントデータ
    const varietyAccount = ["アカウント名","ID","PW","URL"];
    ...
    const Account_lefts = [Account_left1,Account_left2,Account_left3];
    const Account_rights = [Account_right1,Account_right2,Account_right3];
    await AccountSelect(varietyAccount,Account_left1,Account_left2,Account_left3,Account_right1,Account_right2,Account_right3);
    ...
    // バラエティのアカウントで最初にログインする
    await YoutubeLogin(varietyAccount);
    await RPA.sleep(2000);
    for(let i in SheetDatas1){
        if(SheetDatas1[i][0] == "true"){
            await Youtube2ndLogin(Account_lefts[i]);
    ...
    for(let i in SheetDatas2){
        if(SheetDatas2[i][0] == "true"){
            await Youtube2ndLogin(Account_rights[i]);
...
async function AccountSelect(varietyAccount,Account_left1,Account_left2,Account_left3,Account_right1,Account_right2,Account_right3){
    // 設定するアカウントを取得する
    ...
    varietyAccount[1] = firstAccountData[7][15];
    varietyAccount[2] = firstAccountData[7][16];
    varietyAccount[3] = firstAccountData[7][17];
