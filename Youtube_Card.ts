...
async function YoutubeLogin(Account){
    await RPA.WebBrowser.driver.manage().window().maximize();
...
async function Youtube2ndLogin(Account){
    ...
    const AccountButton = await RPA.WebBrowser.wait(RPA.WebBrowser.Until.elementLocated({id:'avatar-btn'}),5000);
